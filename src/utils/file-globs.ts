...
export const getFilePathKey = (filePath: string, platform = process.platform): string => {
  const normalized = normalizePath(filePath);
  return getGlobMatchOptions(platform).nocase ? normalized.toLowerCase() : normalized;
};
